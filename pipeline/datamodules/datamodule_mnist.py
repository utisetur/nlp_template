...
from pipeline.datasets.mnist_dataset import MnistDataset
...
class MNISTDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(self.mnist_train, batch_size=self.cfg.datamodule.batch_size)

    def val_dataloader(self):
        return DataLoader(self.mnist_val, batch_size=self.cfg.datamodule.batch_size)

    def test_dataloader(self):
        return DataLoader(self.mnist_test, batch_size=self.cfg.datamodule.batch_size)
